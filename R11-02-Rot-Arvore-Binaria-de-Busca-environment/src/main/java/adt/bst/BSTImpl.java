...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
   ...
   private void preOrderRec(BSTNode<T> node, ArrayList<T> aux) {
   ...
   private void OrderRec(BSTNode<T> node, ArrayList<T> aux) {
   ...
   private void postOrderRec(BSTNode<T> node, ArrayList<T> aux) {
